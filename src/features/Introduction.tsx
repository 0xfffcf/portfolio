    ...
    return (
        <div className='flex m-auto flex-col items-center overflow-x-hidden'>
            <div className='flex md:w-[38rem] md:h-40 h-36 w-[20rem] flex-col'>
                <div className='blur-xl ml-2 mt-[2px] md:w-[4.5rem] w-[4.2rem] md:h-6 h-5 absolute bg-gradient-to-tr from-pink-700 to-purple-700 opacity-20 rounded-full' />
                ...
                <div className='flex mt-1 p-2 md:w-[38rem] rounded-lg bg-zinc-200 dark:bg-md-black '>
                    <p className='lg:text-xl md:text-lg text-sm font-extralight'>
                        Welcome to my secret garden where I share what I&apos;ve
                        made and learned in my journey as a junior software
                        engineer. I am currently working as a full-stack
                        engineer at a confidential place.
                    </p>
                </div>
            </div>
        </div>
