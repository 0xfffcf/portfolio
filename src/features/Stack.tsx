  ...
  return (
    <div className='flex m-auto flex-col items-center'>
      <div className='flex md:w-[38rem] md:h-40 h-36 w-[20rem] flex-col'>
        <div className='blur-xl md:mt-1 mt-[1.5px] md:w-[12.6rem] w-[11.5rem] h-5 absolute bg-gradient-to-tr from-pink-700 to-purple-700 opacity-30 dark:opacity-20 rounded-full' />
        ...
        <div className='flex lg:h-24 md:w-[38rem] p-2 rounded-lg bg-zinc-200 dark:bg-md-black'>
