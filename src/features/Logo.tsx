...
const Logo = () => {
  return (
    <motion.div
      ...
      variants={floating}
    >
      <div className='blur-xl absolute md:w-[32rem] w-[20rem] md:h-20 h-14 md:mt-5 mt-[0.5rem] bg-gradient-to-tr from-pink-700 to-purple-700 opacity-20 dark:opacity-10 rounded-full' />
